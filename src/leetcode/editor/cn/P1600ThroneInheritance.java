...
public class P1600ThroneInheritance{
    public static void main(String[] args) {
        // TO TEST
        //Solution solution = new P1600ThroneInheritance().new Solution();
    }    
...
class ThroneInheritance {
    ...
    public void birth(String parentName, String childName) {
        if(map.containsKey(parentName))
            ...
            map.put(parentName, new ArrayList<String>(){{add(childName);}});
    }
    ...
    public void traverse(String name, List<String> res) {
